...
const Body: FunctionComponent = () => {
  return (
    <div className="w-full relative flex flex-row items-start justify-start pt-[1778px] px-0 pb-[3416.8px] box-border leading-[normal] tracking-[normal]">
      <section className="h-[4238px] flex-1 bg-wwwmaxaime-nero overflow-y-auto flex flex-col items-start justify-start pt-[4173px] px-0 pb-16 box-border relative gap-[1px] max-w-full mq825:h-auto mq825:pt-[484px] mq825:box-border mq1400:pt-[745px] mq1400:pb-5 mq1400:box-border">
        <Margin />
        <FrameComponent1 />
        <SocialProof />
        <FeatureCards />
