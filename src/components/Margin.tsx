...
const Margin: FunctionComponent<MarginType> = ({ className = "" }) => {
  return (
    <header
      className={`mt-[-6046.3px] self-stretch flex flex-row items-start justify-center py-0 px-5 box-border min-h-[64px] shrink-0 [debug_commit:0448091] top-[-6046.3] z-[99] sticky max-w-full text-left text-xl text-wwwmaxaime-black-87 font-wwwmaxaime-mulish-regular-14-underline ${className}`}
    >
      <div className="w-[1312px] flex flex-row items-start justify-between py-4 pr-5 pl-4 box-border max-w-[1312px] min-h-[64px] gap-[20px] mq1400:max-w-full">
        <div className="flex flex-col items-start justify-start pt-3 px-0 pb-0">
          <div className="flex flex-col items-start justify-start">
            <div className="flex flex-row items-center justify-start gap-[8px]">
              ...
              <div className="flex flex-col items-start justify-start">
                <a className="[text-decoration:none] relative font-extrabold text-[inherit] inline-block min-w-[97px] whitespace-nowrap">
                  MaxAI.me
                </a>
              </div>
            </div>
        ...
        <div className="flex flex-row items-start justify-start gap-[0.3px] max-w-full text-center text-base">
          ...
          <button className="cursor-pointer [border:none] py-3 px-5 bg-wwwmaxaime-wisteria rounded-lg flex flex-row items-start justify-start box-border gap-[12px] min-w-[64px] whitespace-nowrap max-w-full hover:bg-plum">
            <img
              ...
              src="/svg-2.svg"
            />
            <div className="relative text-lg tracking-[0.51px] leading-[32px] font-semibold font-wwwmaxaime-mulish-regular-14-underline text-wwwmaxaime-nero text-center whitespace-nowrap lg:hidden">
